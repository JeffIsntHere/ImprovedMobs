...
public class ConfigSpecs {
    ...
    static class CommonConfigVals {
        ...
        public final ForgeConfigSpec.EnumValue<Config.IntegrationType> useRunecraftoryMod;
        public final ForgeConfigSpec.DoubleValue runecraftoryScale;
        ...
        public CommonConfigVals(ForgeConfigSpec.Builder builder) {
            ...
            this.useLevelZMod = builder.comment("If true and LevelZ is installed will use the total skill level from LevelZ as difficulty").defineEnum("Use LevelZ Mod", Config.CommonConfig.useLevelZMod);
